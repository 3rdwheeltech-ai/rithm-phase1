"""Alembic env for the 'conversation' module (sync psycopg2; raw-SQL migrations).
...
DSN = settings.db_conversation_dsn.get_secret_value()
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="conversation",
    )
